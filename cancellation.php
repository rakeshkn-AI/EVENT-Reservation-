...
<div id="wrapper">
	...
	<!--<h1><a href="index.php"><img src="xres/images/logo.png" class="logo" alt="Hall Reservation System" /></a></h1>-->
	    ...
	    <li ><a href="index.php">Home</a></li>
			...
			<li class="current"><a href="cancellation.php">Cancellation</a></li>
    	</ul>
		</div>
	</div>
    <div id="content">
    	<div id="rotator">
			  ...
			  <div id="logo" style="left: 600px; height: auto; top: 23px; width: 260px; position: absolute; z-index:4;">
					...
					<div class="accordion-content" style="margin-bottom: 15px;">
						...
						<span style="margin-right: 11px;">Confirmation Number: <input type="text" name="confirmation" style="width: 165px; margin-left: 15px; border: 3px double #CCCCCC; padding:5px 10px;" required/></span><br><br>
