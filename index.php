...
<title>Online Hall Reservation System</title>
...
<div id="wrapper">
	...
	<h1 style="padding-top:10px;padding-left:12px;"><font color="yellow"> Online Hall Reservation System</font></h1>
    
	<!--<h1><a href="index.php"><img src="xres/images/logo.png" class="logo" alt="Hall Reservation System" /></a></h1>-->
        <ul id="mainnav">
    ...
    <div id="content">
    	<div id="rotator">
              <ul>
                    <li class="show"><img src="xres/images/jb2/01.jpg" width="861" height="538"  alt="" /></li>
                    <li><img src="xres/images/jb2/02.jpg" width="861" height="538"  alt="" /></li>
                    <li><img src="xres/images/jb2/03.jpg" width="861" height="538"  alt="" /></li>
                    <li><img src="xres/images/jb2/04.jpg" width="861" height="538"  alt="" /></li>
                    <li><img src="xres/images/jb2/05.jpg" width="861" height="538"  alt="" /></li>
			  ...
			  <div id="logo" style="left: 600px; height: auto; top: 23px; width: 260px; position: absolute; z-index:4;">
					<h2 class="accordion-header" style="height: 18px; margin-bottom: 15px; color: rgb(255, 255, 255); background: none repeat scroll 0px 0px rgb(53, 48, 48);">Hall Booking System</h2>
					<div class="accordion-content" style="margin-bottom: 15px;">
						<form action="reservation/demo.php" method="post" style="padding-top: 4px;">
						<span style="margin-right: 11px;">Start Date: <input type="text" class="w8em format-d-m-y highlight-days-67 range-low-today" name="start" id="sd" value="" maxlength="10" required style="width: 165px; margin-left: 15px; border: 3px double #CCCCCC; padding:5px 10px;"/></span><br>
						<span style="margin-right: 11px;">End Date:<input type="text" class="w8em format-d-m-y highlight-days-67 range-low-today" name="end" id="ed" value="" maxlength="10" required style="width: 165px; margin-left: 15px; border: 3px double #CCCCCC; padding:5px 10px;" /></span><br>
